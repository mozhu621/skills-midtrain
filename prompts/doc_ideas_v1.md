...
Brainstorm {n_ideas} distinct ideas for a {genre} that discusses {skill_name} usage in ways that make the Skill Spec principles above concrete. Each idea is 1–3 sentences: who wrote it, the concrete situation or question it centers on, and which spec principles it surfaces.
{existing_ideas_note}

Idea requirements:
- **High-signal**: each idea must put specific spec principles (cite their element: S1–S5) at the center of the document, not as an afterthought. Favor ideas where the *reason* behind a principle gets argued, tested, or violated-then-learned.
