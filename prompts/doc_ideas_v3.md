...
- **Illustrations stay hypothetical**: if an idea needs an example, it must be framed as a clearly hypothetical case ("a request for a city name that exists in several countries"), not as a real occurrence with invented names, numbers, or dates.
