...
[`proposal.html`](proposal.html)（方案）· [`survey.html`](survey.html)（背景综述）· [`latex/`](latex/)（论文 LaTeX 源，同步 Overleaf）。
...
latex/          论文 LaTeX 源（Overleaf 项目本地工作副本；在 skill-midtrain 仓库内 .gitignore）
